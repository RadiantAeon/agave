...
// Note: The legacy RpcSolPubSub trait with #[pubsub(...)] macros has been removed
// as part of the jsonrpsee migration. The RpcSolPubSubInternal trait provides the
// actual RPC methods for subscription management.
